...
def run(*argv):
    ...
    parser.add_argument('--datapath', type=str, default='../seqGAN-tensorflow-master/data',
    ...
    parser.add_argument('--out_dir', type=str, default="../seqGAN-tensorflow-master/output",
    help='Output directory for test output. Default: ../seqGAN-tensorflow-master/output')
    parser.add_argument('--log_dir', type=str, default="../seqGAN-tensorflow-master/tensorboard",
    help='Log directory for tensorboard. Default: ../seqGAN-tensorflow-master/tensorboard')
    parser.add_argument('--model_dir', type=str, default="../seqGAN-tensorflow-master/model/big_data_model",    
    help='Checkpoints directory for model. Default: ../seqGAN-tensorflow-master/model/big_data_model')
    parser.add_argument('--cache_dir', type=str, default="../seqGAN-tensorflow-master/cache",
    help='Checkpoints directory for cache. Default: ../seqGAN-tensorflow-master/cache')
    ...
    args.grad_clip = 5.0
    args.show_sample = [0]
    args.checkpoint_steps = 2000
    args.checkpoint_max_to_keep = 5
    args.teacher_forcing = True

    args.gen_pre_epoch_num = 10 # 25 #Number of pretraining epoch
    args.dis_pre_epoch_num = 1 #pretraining times of discriminator
    args.total_adv_batch = 5 #200 total batch used for adversarial training
    args.gen_adv_batch_num = 10 # 120 #update times of generator in adversarial training
